...
public interface Proximity extends ProximityRequestMulticaster {
    ...
    /**
         * Stores item on it's supplied path. Proximity does not handle
         * directories separatly, if you store item on path /a/b/c/some.jar, the
         * dir structure /a/b/c will be created if not exists. Only files can be
         * stored, directories not.
         * 
         * @param request
         * @param item
         * @throws AccessDeniedException
         * @throws NoSuchRepositoryException
         */
    void storeItem(ProximityRequest request, Item item) throws AccessDeniedException, NoSuchRepositoryException, RepositoryNotAvailableException;

    /**
         * Copies item from source to target location. Source should be
         * retrievable by retrieveItem(downloadable or cached).
         * 
         * @param source
         * @param target
         * @throws ItemNotFoundException
         ...
         * @throws NoSuchRepositoryException
         */
    void copyItem(ProximityRequest source, ProximityRequest target) throws ItemNotFoundException, AccessDeniedException, NoSuchRepositoryException,
    ...
    /**
         ...
         * @throws NoSuchRepositoryException
         */
    void moveItem(ProximityRequest source, ProximityRequest target) throws ItemNotFoundException, AccessDeniedException, NoSuchRepositoryException,
	    RepositoryNotAvailableException;
    ...
    /**
         ...
         * @throws NoSuchRepositoryException
         */
    void deleteItem(ProximityRequest request) throws ItemNotFoundException, AccessDeniedException, NoSuchRepositoryException,
	    RepositoryNotAvailableException;
    ...
    /**
         ...
         * Repositories. It will ALWAYS return List, at least a 0 length list.
         * Will not return null or throw exception in normal circumstances.
         * 
         * @param path

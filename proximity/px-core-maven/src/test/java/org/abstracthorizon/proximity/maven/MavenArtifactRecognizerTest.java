...
import org.abstracthorizon.proximity.maven.MavenArtifactRecognizer;
...
public class MavenArtifactRecognizerTest extends TestCase {
	...
	public void testIsSnapshot1() {
		Assert.assertEquals(true, MavenArtifactRecognizer.isSnapshot("/org/somewhere/aid/1.0-SNAPSHOT",
				"xsd-SNAPSHOT.jar"));
		Assert.assertEquals(true, MavenArtifactRecognizer.isSnapshot("/org/somewhere/aid/1.0-SNAPSHOT",
				"xsd-SNAPSHOT.pom"));
		Assert.assertEquals(true, MavenArtifactRecognizer.isSnapshot("/org/somewhere/aid/1.0-SNAPSHOT",
		...
		Assert.assertEquals(false, MavenArtifactRecognizer.isSnapshot("/org/somewhere/aid/1.0",
